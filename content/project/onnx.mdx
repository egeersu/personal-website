...
time: "2019"
description: "KnetOnnx reads an ONNX file and creates the corresponding Model in Julia, which can then be re-trained or used for inference."
url: "https://github.com/egeersu/KnetOnnx.jl"
tags: ["ONNX", "Julia", "Deep Learning", "Machine Learning", "Open Source"]
---
