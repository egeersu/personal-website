---
title: "Position-Aware Neural Attentive Graph Networks for Question Answering"
time: "2021"
description: "Deep Learning Research Paper. We used Graph Neural Networks to solve a Multi-hop Question Answering task."
url: "https://github.com/egeersu/Multihop-GNN"
tags: ["Graph Neural Networks", "Deep Learning", "Question Answering", "PyTorch"]
---
 
## Paper
[Position-Aware Neural Attentive Graph Networks for Question Answering (2021)](https://www.egeersu.com/projects/graph_neural/multihop.pdf)
